...
class Avr8Protocol(Jtagice3Protocol):
    ...
    AVR8_FAILURE_INVALID_ALIGNMENT = 0x37
    AVR8_FAILURE_ILLEGAL_MEMORY_RANGE = 0x38  # Address not within legal range
    AVR8_FAILURE_ILLEGAL_VALUE = 0x39
    AVR8_FAILURE_ILLEGAL_ID = 0x3A  # Illegal target ID
    AVR8_FAILURE_INVALID_CLOCK_SPEED = 0x3B
    AVR8_FAILURE_TIMEOUT = 0x3C
    AVR8_FAILURE_ILLEGAL_OCD_STATUS = 0x3D  # Read an OCD status that is illegal (reserved bits set)

    AVR8_FAILURE_NVM_ENABLE = 0x40
    AVR8_FAILURE_NVM_DISABLE = 0x41
    AVR8_FAILURE_CS_ERROR = 0x42
    AVR8_FAILURE_CRC_FAILURE = 0x43
    AVR8_FAILURE_OCD_LOCKED = 0x44
    AVR8_FAILURE_KEY_ERROR = 0x45
    AVR8_FAILURE_BOOT_ERROR = 0x46
    AVR8_FAILURE_ACK_ERROR = 0x47

    AVR8_FAILURE_NO_OCD_CONTROL = 0x50
    AVR8_FAILURE_PLEASE_TOGGLE_POWER = 0x51
    AVR8_FAILURE_NO_VOUT_SET = 0x52
    AVR8_FAILURE_VOUT_ERROR = 0x53

    AVR8_FAILURE_PC_READ_FAILED = 0x60  # Error when reading PC
    AVR8_FAILURE_REGISTER_READ_FAILED = 0x61  # Error when reading register

    AVR8_FAILURE_READ_ERROR = 0x70
    AVR8_FAILURE_WRITE_ERROR = 0x71
    AVR8_FAILURE_WRITE_TIMEOUT = 0x72

    AVR8_FAILURE_ILLEGAL_BREAKPOINT = 0x80
    AVR8_FAILURE_TOO_MANY_BREAKPOINTS = 0x81

    AVR8_FAILURE_NOT_SUPPORTED = 0x90
    AVR8_FAILURE_NOT_IMPLEMENTED = 0x91  # The command has not been implemented

    AVR8_FAILURE_UNKNOWN = 0xFF
    ...
    AVR8_OPT_12V_UPDI_ENABLE = 0x06  # //! Back-compatibility for the above option
    ...
    AVR8_VARIANT_TINYX = 0x05  # //! New tiny and mega-0 (UPDI) devices
    AVR8_VARIANT_PIC1618 = 0x06  # //! PIC
    ...
    AVR8_PHY_INTF_PDI_3W = 0x0A  # //! 3W mode
    AVR8_PHY_INTF_ICSP = 0x0B  # //! PIC

    # Do not use high-voltage to enable UPDI
    UPDI_HV_NONE = 0x00
    UPDI_12V_NONE = 0x00  # Back-compatibility
    # Issue a single high-voltage pulse immediately to enable UPDI
    UPDI_HV_SIMPLE_PULSE = 0x01
    # Toggle power automatically (if capable) and then issue a high-voltage pulse to enable UPDI
    UPDI_HV_AUTO_POWER_TOGGLE = 0x02
    # The user toggles power, and the tool applies a high-voltage pulse on power-up to enable UPDI
    UPDI_HV_USER_POWER_TOGGLE = 0x03

    AVR8_MEMTYPE_SRAM = 0x20
    AVR8_MEMTYPE_EEPROM = 0x22
    AVR8_MEMTYPE_IO_SHADOW = 0x30
    ...
    AVR8_MEMTYPE_CAN = 0xB6
    AVR8_MEMTYPE_TBUS = 0xB7
